...
function strapword_widgets_init() {
   ...
   */
   ...
   register_sidebar( array(
    'name'            => __( 'Mainbody Widget Area 1', 'strapword' ),
    'id'              => 'mainbody-widget-area-1',
    'description'     => __( 'Use 1, 2, 3 or 4 widgets.', 'strapword' ),
  ...
  register_sidebar( array(
    'name'            => __( 'Footer Widget Area', 'strapword' ),
...
add_action( 'widgets_init', 'strapword_widgets_init' );