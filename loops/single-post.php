...
<?php if(have_posts()): while(have_posts()): the_post(); ?>
      ...
      <div class="header-metas d-flex justify-content-center align-items-center my-5 text-muted">
        ...
        <div class="pe-3 d-flex align-items-center">
          ...
          <div class="me-1 border rounded-circle overflow-hidden">
            <?php strapword_author_avatar(); ?>
          </div>
          <?php _e('By', 'strapword'); echo '&nbsp;'; the_author_posts_link(); ?>
        </div>

        <div class="pe-3">
          <i class="bi bi-calendar3"></i>
          <?php strapword_post_date(); ?>
        </div>
        ...
        <div>
          ...
          <a href="#post-comments"><?php
            ...
            printf(
              ...
              esc_html( _nx( '%1$s comment', '%1$s comments', $comment_count, 'strapword' ) ),
  ...
  <section class="wrap-md author-bio d-flex border-top border-bottom py-5">
    <div class="border rounded-circle overflow-hidden">
      <?php strapword_author_bio_avatar(); ?>
    </div>
    <div class="ms-3">
      <p class="h4 author-name"><?php _e('Author: ', 'strapword'); the_author(); ?></p>
      <?php if (strapword_author_description()) {
        ?>
        <div class="author-description"><?php strapword_author_description(); ?></div>
        <?php
      } ?>
      <p class="author-other-posts mb-0"><?php _e('Other posts by ', 'strapword'); the_author_posts_link(); ?></p>
    </div>
  </section><!-- /.author-bio -->
