...
<header class="wrap-lg py-5 text-center">
  <h1 class="display-2 my-5">
    <?php _e('Search Results for', 'strapword'); ?> &ldquo;<?php the_search_query(); ?>&rdquo;
  </h1>
</header>
...
<?php endwhile; else: ?>
  <div class="wrap-md pb-5 entry-content">
    <article class="alert alert-warning px-3">
      <i class="bi bi-exclamation-triangle"></i> <?php _e('Sorry, your search yielded no results.', 'strapword'); ?>
    </article>
  </div>
<?php endif; ?>
