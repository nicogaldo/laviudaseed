...
<div class="yith-wcwl-add-button">
	<a
		...
		class="btn delete_item <?php echo esc_attr( $link_classes ); ?>"
	...
	<?php if ( $show_view ) : ?>
		<span class="separator d-inline-block small">
            <a href="<?php echo esc_url( $found_in_list->get_url() ); ?>" class="view-wishlist">Ver lista de deseos &rsaquo;</a>
        </span>
	<?php endif; ?>
</div>
