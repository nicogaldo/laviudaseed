...
<div class="yith-wcwl-wishlistexistsbrowse" title="<?php echo $already_in_wishslist_text ?>">
    <a href="<?php echo esc_url( $wishlist_url ) ?>" rel="nofollow" data-title="<?php echo esc_attr( $browse_wishlist_text ) ?>" class="btn btn-primary">
        <span class="feedback">
            <?php //echo $icon ?>
